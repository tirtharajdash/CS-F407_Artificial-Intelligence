...
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| Teaching Assistants (TAs) | [TA1]() &nbsp;&nbsp;&nbsp; [TA2]() &nbsp;&nbsp;&nbsp; [TA3]() &nbsp;&nbsp;&nbsp; [TA4]()  |

The course handout can be found [here](https://github.com/tirtharajdash/CS-F407_Artificial-Intelligence/tree/main/handouts). 

### Lectures

| Week | Lecture | Content |
| ---- | ------- | ------- |
| Week 1 | L1 | Introduction to AI (Past, Present, Future) (AS) |
| Week 1 | L2 | Introduction to Foundation Models I (TD) [slides](https://github.com/tirtharajdash/CS-F407_Artificial-Intelligence/tree/main/lectures/introfm.pdf) |
